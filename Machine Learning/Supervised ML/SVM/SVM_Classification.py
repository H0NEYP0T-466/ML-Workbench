...
for i in range(600):
    # Create two clusters with some noise
    if i < 300:
        # Class 0 - centered around (2, 2)
        feature1 = np.random.normal(2, 1.5)
        feature2 = np.random.normal(2, 1.5)
        class_label = 0
    else:
        # Class 1 - centered around (6, 6)  
        feature1 = np.random.normal(6, 1.5)
...
feature1_input = float(input("Enter feature1 value (typically 0-8): "))
feature2_input = float(input("Enter feature2 value (typically 0-8): "))
...
plt.title("SVM Classification: Correct vs Wrong Predictions")
plt.legend()
plt.show()
